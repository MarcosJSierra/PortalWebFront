        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <div className="container-fluid">
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link active" aria-current="page" to="/distribuidores">Distribuidores</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link active" aria-current="page" to="/canalesautorizados">Canales Autorizados</Link>
                    </li>
                </ul>
                </div>
            </div>
